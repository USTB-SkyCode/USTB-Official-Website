...
window.APP_CONFIG = {
  ...
  MODEL_COMPILED_BASE_URL: '${MODEL_COMPILED_BASE_URL}',
  MODEL_ASSET_BASE_URL: '${MODEL_ASSET_BASE_URL}',
  BASIC_BASE_URL: '${BASIC_BASE_URL}',
  BASIC_COMPILED_BASE_URL: '${BASIC_COMPILED_BASE_URL}',
  BASIC_ASSET_BASE_URL: '${BASIC_ASSET_BASE_URL}',
