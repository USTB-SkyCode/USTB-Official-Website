...
import { assertPipelineCompatibility } from '@render/backend/shared/contracts/PipelineContracts'
import type { VertexLayoutDescriptor } from '@render/layout/VertexLayoutDescriptor'
import { WebGL2GeometryResource } from '../resource/WebGL2GeometryResource'
import type { WebGL2Mesh } from '../resource/WebGL2Mesh'
import { WebGL2PipelineLibrary } from '../pipeline/WebGL2PipelineLibrary'
...
export class WebGL2RenderBackend implements IRenderBackend {
  ...
  public createExternalGeometry(
    params: ExternalGeometryArtifact & { resource: WebGL2Mesh },
  ): GeometryHandle {
    const id = this.nextGeometryId++
