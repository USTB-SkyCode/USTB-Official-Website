...
import { MAX_HOLOGRAM_PANELS } from '@render/backend/webgl2/ui3d/HologramPanel'
...
import HOLOGRAM_FRAGMENT_SHADER from '@render/backend/webgl2/shaders/screen/hologram_composite.fsh'
