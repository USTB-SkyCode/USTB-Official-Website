...
import vsh from '@render/backend/webgl2/shaders/terrain/shadow.vsh'
import fsh from '@render/backend/webgl2/shaders/common/shadow.fsh'
import characterCutoutVsh from '@render/backend/webgl2/shaders/entity/character_shadow.vsh'
import characterCutoutFsh from '@render/backend/webgl2/shaders/entity/character_shadow.fsh'
import { ShadowManager } from '@render/backend/webgl2/lighting/ShadowManager'
import { SHADOW_TEXTURE_UNITS } from '@render/backend/webgl2/bindings/TextureUnits'
