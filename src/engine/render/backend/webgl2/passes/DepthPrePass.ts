...
import vsh from '@render/backend/webgl2/shaders/terrain/depth_prepass.vsh'
import fsh from '@render/backend/webgl2/shaders/common/depth_prepass.fsh'
import characterCutoutVsh from '@render/backend/webgl2/shaders/entity/character_depth_prepass.vsh'
import characterCutoutFsh from '@render/backend/webgl2/shaders/entity/character_depth_prepass.fsh'
